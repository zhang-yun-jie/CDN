...
https://cdn.jsdelivr.net/npm/仓库名@版本号/文件路径

https://cdn.staticaly.com/gh/zhang-yun-jie/cdn@branch/example.js

https://npm.elemecdn.com/仓库名@版本号/文件路径

https://cdnjs.cloudflare.com/ajax/libs/example/version/example.js( https://www.cloudflare-cn.com注册 )
